        ...
        <div class="row">
            ...
            <div class="col-xl-9 col-lg-8 ">
                <div class="card">
                    ...
                    <div class="card-body">
                        <!-- File Upload -->
                        <form action="https://techzaa.in/" method="post" class="dropzone dz-clickable"
                                ...
                                <form>
                                    ...
                                    <div class="choices" data-type="select-one" tabindex="0" role="combobox"
                                        ...
                                        <div class="choices__inner"><select class="form-control choices__input"
                                                ...
                                                <option value="Fashion" data-custom-properties="[object Object]">Fashion
                                                </option>
                                            </select>
                                            <div class="choices__list choices__list--single">
                                                <div class="choices__item choices__item--selectable" data-item=""
                                                    data-id="1" data-value="Fashion"
                                                    data-custom-properties="[object Object]" aria-selected="true">Fashion
                                                </div>
                                            </div>
                                        </div>
                                        <div class="choices__list choices__list--dropdown" aria-expanded="false"><input
                                                ...
                                                aria-autocomplete="list" aria-label="Choose a categories" placeholder="">
                                            <div class="choices__list" role="listbox">
                                                <div id="choices--product-categories-item-choice-2"
                                                    ...
                                                    aria-selected="true">Choose a categories</div>
                                                <div id="choices--product-categories-item-choice-1"
                                                    class="choices__item choices__item--choice choices__item--selectable"
                                                    role="option" data-choice="" data-id="1" data-value="Appliances"
                                                    data-select-text="Press to select" data-choice-selectable="">
                                                    Appliances</div>
                                                <div id="choices--product-categories-item-choice-3"
                                                    class="choices__item choices__item--choice choices__item--selectable"
                                                    role="option" data-choice="" data-id="3"
                                                    data-value="Electronics" data-select-text="Press to select"
                                                ...
                                                <div id="choices--product-categories-item-choice-4"
                                                    ...
                                                    role="option" data-choice="" data-id="4" data-value="Fashion"
                                                    data-select-text="Press to select" data-choice-selectable="">Fashion
                                                </div>
                                                <div id="choices--product-categories-item-choice-5"
                                                    class="choices__item choices__item--choice choices__item--selectable"
                                                    role="option" data-choice="" data-id="5" data-value="Footwear"
                                                    data-select-text="Press to select" data-choice-selectable="">Footwear
                                                </div>
                                                <div id="choices--product-categories-item-choice-6"
                                                    class="choices__item choices__item--choice choices__item--selectable"
                                                    role="option" data-choice="" data-id="6" data-value="Furniture"
                                                    data-select-text="Press to select" data-choice-selectable="">Furniture
                                                </div>
                                                <div id="choices--product-categories-item-choice-7"
                                                    class="choices__item choices__item--choice choices__item--selectable"
                                                    role="option" data-choice="" data-id="7" data-value="Headphones"
                                                    data-select-text="Press to select" data-choice-selectable="">
                                                    Headphones</div>
                                                <div id="choices--product-categories-item-choice-8"
                                                    class="choices__item choices__item--choice choices__item--selectable"
                                                    role="option" data-choice="" data-id="8"
                                                    data-value="Other Accessories" data-select-text="Press to select"
                                                    data-choice-selectable="">Other Accessories</div>
                                                <div id="choices--product-categories-item-choice-9"
                                                    class="choices__item choices__item--choice choices__item--selectable"
                                                    role="option" data-choice="" data-id="9" data-value="Sportswear"
                                                    data-select-text="Press to select" data-choice-selectable="">
                                                    Sportswear</div>
                                                <div id="choices--product-categories-item-choice-10"
                                                    class="choices__item choices__item--choice choices__item--selectable"
                                                    role="option" data-choice="" data-id="10" data-value="Watches"
                                                    data-select-text="Press to select" data-choice-selectable="">Watches
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-4">
                                <form>
                                    ...
                                    <div class="choices" data-type="select-one" tabindex="0" role="combobox"
                                        aria-autocomplete="list" aria-haspopup="true" aria-expanded="false">
                                        <div class="choices__inner"><select class="form-control choices__input"
                                                id="gender" data-choices="" data-choices-groups=""
                                                data-placeholder="Select Gender" hidden="" tabindex="-1"
                                                data-choice="active">
                                                <option value="Men" data-custom-properties="[object Object]">Men
                                                </option>
                                            </select>
                                            <div class="choices__list choices__list--single">
                                                <div class="choices__item choices__item--selectable" data-item=""
                                                    data-id="1" data-value="Men"
                                                    data-custom-properties="[object Object]" aria-selected="true">Men
                                                </div>
                                            </div>
                                        </div>
                                        <div class="choices__list choices__list--dropdown" aria-expanded="false"><input
                                                ...
                                                class="choices__input choices__input--cloned" autocomplete="off"
                                                autocapitalize="off" spellcheck="false" role="textbox"
                                                aria-autocomplete="list" aria-label="Select Gender" placeholder="">
                                            <div class="choices__list" role="listbox">
                                                <div id="choices--gender-item-choice-3"
                                                    class="choices__item choices__item--choice choices__placeholder choices__item--selectable is-highlighted"
                                                    role="option" data-choice="" data-id="3" data-value=""
                                                    data-select-text="Press to select" data-choice-selectable=""
                                                    aria-selected="true">Select Gender</div>
                                                <div id="choices--gender-item-choice-1"
                                                    class="choices__item choices__item--choice is-selected choices__item--selectable"
                                                    role="option" data-choice="" data-id="1" data-value="Men"
                                                    data-select-text="Press to select" data-choice-selectable="">Men</div>
                                                <div id="choices--gender-item-choice-2"
                                                    class="choices__item choices__item--choice choices__item--selectable"
                                                    role="option" data-choice="" data-id="2" data-value="Other"
                                                    data-select-text="Press to select" data-choice-selectable="">Other
                                                </div>
                                                <div id="choices--gender-item-choice-4"
                                                    class="choices__item choices__item--choice choices__item--selectable"
                                                    role="option" data-choice="" data-id="4" data-value="Women"
                                                    data-select-text="Press to select" data-choice-selectable="">Women
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="choices__inner"><select class="form-control choices__input"
                                        ...
                                        <div class="choices__list choices__list--multiple">
                                            <div class="choices__item choices__item--selectable" data-item=""
                                                ...
                                                data-deletable="">Fashion<button type="button" class="choices__button"
                                                    aria-label="Remove item: 'Fashion'" data-button="">Remove
                                                    item</button></div>
                                    ...
                                    <div class="choices__list choices__list--dropdown" aria-expanded="false">
                                        <div class="choices__list" aria-multiselectable="true" role="listbox">
                                            <div id="choices--choices-multiple-remove-button-item-choice-1"
                                                ...
                                                role="option" data-choice="" data-id="1" data-value="Electronics"
                                                data-select-text="Press to select" data-choice-selectable=""
                                                aria-selected="true">Electronics</div>
                                            <div id="choices--choices-multiple-remove-button-item-choice-3"
                                                class="choices__item choices__item--choice choices__item--selectable"
                                                role="option" data-choice="" data-id="3" data-value="Headphones"
                                                data-select-text="Press to select" data-choice-selectable="">Headphones
                                            </div>
                                            <div id="choices--choices-multiple-remove-button-item-choice-4"
                                                class="choices__item choices__item--choice choices__item--selectable"
                                                role="option" data-choice="" data-id="4" data-value="Watches"
                                                data-select-text="Press to select" data-choice-selectable="">Watches</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
