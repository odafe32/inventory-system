                    ...
                    <div class="card-body">
                        <form action="{{ route('invoices.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="sender_address" id="sender_address" class="form-control @error('sender_address') is-invalid @enderror"
                                            rows="3">{{ $user->business_address }}</textarea>
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="invoice_number" id="invoice_number"
                                            class="form-control bg-light" value="{{ $invoice_number }}" readonly>
                                    </div>
                                    <div class="mb-3">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="issue_from_address" id="issue_from_address"
                                            class="form-control @error('issue_from_address') is-invalid @enderror" rows="3">{{ $user->business_address }}</textarea>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="issue_for_address" id="issue_for_address"
                                            class="form-control @error('issue_for_address') is-invalid @enderror" rows="3"></textarea>
                                        ...
                                        <tr class="product-row">
                                            <td>
                                                <input type="text" name="products[0][name]"
                                                    class="form-control mb-2 product-name" placeholder="Product Name"
                                                    required>
                                                <input type="text" name="products[0][size]"
                                                    class="form-control product-size" placeholder="Size (optional)">
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <input type="number" name="products[0][tax]"
                                                    class="form-control product-tax" value="0" min="0"
                                                    step="0.01">
                                            </td>
                                            <td>
                                                <input type="number" name="products[0][total]"
                                                    class="form-control product-total" value="0" readonly>
                                            </td>
                            ...
                            <div class="mt-4 text-center">
                                ...
                                <a href="{{ route('invoices') }}" class="btn btn-light btn-lg px-5 ms-2">Cancel</a>
                            </div>
                        </form>
                    </div>
                </div>
